...
export namespace FunctionalityShort {
  export const feedServer: FunctionalityShort = {
    ...
    functionalityDescription:
      'A [Zenith](./components/zenith/) plugin which connects to an exchange and provides streaming and/or historical market data to other Zenith services.',
  ...
  export const tradingAdapter: FunctionalityShort = {
    ...
    functionalityDescription:
      'An [OMS](./components/oms/) plugin which connects [Order Management](./functionalities/order-management/) to a trading feed for an exchange',
  ...
  export const tradeFeedAdapter: FunctionalityShort = {
    ...
    functionalityDescription:
      'Generates a specialised feed which assists settlement and registries from booking trades to accounts and generating contract notes.',
    componentShort: ComponentShort.oms,
    componentLink: './components/oms/',
  };
  ...
  export const tradingAgent: FunctionalityShort = {
    ...
    functionalityDescription:
      'Maintains an in-memory picture of [Order Management](./functionalities/order-management/) data for caching proxy and orchestrates [vetting](./functionalities/vetting/) of order requests.',
    componentShort: ComponentShort.zenith,
    componentLink: './components/zenith/',
  };
  ...
  export const cachingProxy: FunctionalityShort = {
    ...
    functionalityDescription:
      'Fulfills subscriptions and data requests from APIs using either cached data or obtaining the data from a [Feed Server](./functionalities/feed-server/) or the [Trading Agent](./functionalities/trading-agent/).',
    componentShort: ComponentShort.zenith,
    componentLink: './components/zenith/',
  };
