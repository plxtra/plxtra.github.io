...
In 2019, Motif Markets acquired the Plxtra intellectual property from Paritech.  It used this to supply an exchange platform to [First Nations Stock Exchange](https://fn-sx.com/) and brokerage platform to [Empower Hub](https://www.em2.asia/) - an API focused brokerage firm owned by [Malacca Securities](https://www.mplusonline.com.my/) in Malaysia.
