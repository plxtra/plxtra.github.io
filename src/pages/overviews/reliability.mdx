...
* The [Order management system](/architecture/components/order-management-system/) supports redundant connectivity to exchanges. This allows order processing to continue through a secondary connection or exchange if there are issues with the primary.
