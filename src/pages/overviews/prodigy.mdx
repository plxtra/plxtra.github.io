...
Plxtra's matching engine, [Prodigy](/architecture/components/prodigy/), is a multi market matching engine with a market plugin design. It can be accessed either via industry standard [FIX protocol](/architecture/components/fix/) or managed via an internal rest API.
