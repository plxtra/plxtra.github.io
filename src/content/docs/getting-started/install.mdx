...
This page provides a detailed description of how to install the [Plxtra XOSP release](/deploy/what-is-xosp/) onto your local computer. See the [Quick start](../quick-start/) page for a more streamlined description to get you up and running quickly.
...
1. [Running the XOSP installation scripts](#install-xosp)
...
1. Select and download a specific [release from GitHub](https://github.com/plxtra/xosp/releases).
1. Download a zip of the latest code from the [GitHub repository](https://github.com/plxtra/xosp), which will need to be extracted.
1. Use Git locally to clone the repository to your machine, and install directly from the working copy.
...
This script generates the installation configuration. This includes user and database credentials, certificates, as well as applying any [configuration settings](../../configuration/) to customise the installation to your needs.
1. `.\XOSP-Install.ps1`\
...
The specific domain (and SSL port if required) can be overridden with the [configuration settings](../../configuration/) for XOSP.
